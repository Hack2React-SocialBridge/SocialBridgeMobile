  ...
  return (
    <View style={{ padding: 22 }}>
      <View style={{ flexDirection: "row", paddingBottom: 16 }}>
        <Image source={require("../../assets/postIcon.png")}></Image>
        <View style={{ marginLeft: 12, justifyContent: "center" }}>
          ...
          <Text
            style={{ fontFamily: "Helvetica", fontSize: 14, lineHeight: 16 }}
          >
            20 minut temu
          </Text>
        </View>
      ...
      <Text style={{ fontFamily: "Helvetica", fontSize: 16 }}>
        Przykładowy Opis Przykładowy Opis Przykładowy Opis Przykładowy Opis
        Przykładowy Opis Przykładowy Opis Przykładowy Opis Przykładowy Opis
        Przykładowy Opis Przykładowy Opis Przykładowy Opis
      </Text>
      <Image
      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        >
          <LikeSvg />
          <Text style={{ fontFamily: "Helvetica", marginLeft: 10 }}>2440</Text>
        </Pressable>
        <Pressable
          style={{
            flexDirection: "row",
